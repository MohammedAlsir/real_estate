...
<div class="x_panel">
    <div class="x_title">
        <h2>تعديل بيانات الوكيل العقاري
            {{-- <small> </small> --}}
        </h2>
    ...
    <div class="x_content">
        <br />
        <form method="POST" action="{{route('agent.update',$agent->id)}}"  enctype="multipart/form-data" class="form-horizontal form-label-left">
            @csrf
            @method('put')
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="trade_name" value="{{$agent->trade_name}}" id="trade_name" required="required" class="form-control col-md-7 col-xs-12"
                        value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="address" value="{{$agent->address}}"  id="address" required="required"
                        class="form-control col-md-7 col-xs-12" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="license" value="{{$agent->license}}"  id="license" required="required"
                        class="form-control col-md-7 col-xs-12" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="twitter_account" value="{{$agent->twitter_account}}"  id="twitter_account"
                        class="form-control col-md-7 col-xs-12" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="facebook_account" value="{{$agent->facebook_account}}"  id="facebook_account"
                        class="form-control col-md-7 col-xs-12" value="">
                </div>
            </div>
             <div class="form-group">
                ...
                <div class="col-md-4">
                    <img style="width: 150px; height: 150px; object-fit: cover;"  src="{{asset('uploads/agents/logo/'.$agent->logo)}}" alt="لا يوجد شعار حاليا" srcset="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="email" value="{{$agent->email}}"  id="email" required="required"
                        class="form-control col-md-7 col-xs-12" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="status" {{$agent->status == 'on'? 'checked':''}}  type="checkbox" class="js-switch" />
                </div>
            </div>
