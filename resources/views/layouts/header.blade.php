        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <!-- Hotels -->
                    <li><a><i class="fa fa-cubes"></i>الوكلاء العقاريون<span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-cubes"></i>قطع اراضي<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
