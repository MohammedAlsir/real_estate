...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>  الفنادق  {{Helper::GeneralSiteSettings('name')}}
                {{-- <small>کاربران</small> --}}
                <form action="{{route('hotels.index')}}" method="GET" style="display: inline-block; margin-right: 20px">
                    <select  onchange="this.form.submit()"  class="form-control"  name="hotel" id="">
                                    ...
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">بيانات  الفندق </h4>
                                            </div>
