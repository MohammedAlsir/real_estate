...
function init_daterangepicker() {
    ...
    var optionSet1 = {
        ...
        locale: {
            ...
            monthNames: "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژوئیه_اوت_سپتامبر_اکتبر_نوامبر_دسامبر".split(
                "_"
            ),
            firstDay: 1,
        },
...
function init_PNotify() {
    ...
    new PNotify({
        ...
        type: "info",
        text:
            "خوش آمدی. سعی کنید از من دور شوید شما می توانید همه چیز را در پشت من کلیک کنید، زیرا من غیر مسدود شده هستم.",
        nonblock: {
            nonblock: true,
        },
        addclass: "dark",
    ...
    if ($("#echart_world_map").length) {
        ...
        echartMap.setOption({
            title: {
                ...
                subtext:
                    "از سازمان ملل متحد، مجموع جمعیت، هر دو جنس ترکیبی، از 1 جولای (هزاران نفر)",
                x: "center",
                y: "top",
            },
            tooltip: {
