...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        $("#chart_plot_01").length &&
            (console.log("Plot1"), $.plot($("#chart_plot_01"), [e, a], i)),
...
function init_autocomplete() {
    if ("undefined" != typeof autocomplete) {
        ...
        $("#autocomplete-custom-append").autocomplete({ lookup: a });
    }
}
        ...
        $('[data-toggle="tooltip"]').tooltip(),
            ...
            $(".docs-buttons").on("click", "[data-method]", function () {
                ...
                if (
                    ...
                    if (
                        ((i = $.extend({}, i)),
                        "undefined" != typeof i.target &&
                            ((t = $(i.target)), "undefined" == typeof i.option))
                    )
                        try {
                    ...
                    switch (
                        ((n = e.cropper(i.method, i.option, i.secondOption)),
                        i.method)
                    ) {
                        case "scaleX":
                        case "scaleY":
...
function init_validator() {
    "undefined" != typeof validator &&
        ...
        (validator.message.password_repeat =
    ...
    if ("undefined" != typeof $.fn.fullCalendar) {
        ...
        var e,
            ...
            r = $("#calendar").fullCalendar({
                ...
                editable: !0,
                events: [
                    { title: "تمام روز رویداد", start: new Date(i, o, 1) },
                    {
                        title: "رویداد طولانی",
        ...
        var e = function () {
            $("#datatable-buttons").length &&
                $("#datatable-buttons").DataTable({
                    language: {
                        url:
                            "//cdn.datatables.net/plug-ins/1.11.4/i18n/ar.json",
                    },
                    dom: "Bfrtip",
                    buttons: [
                        { extend: "copy", text: "کپی", className: "btn-sm" },
                        {
                            extend: "csv",
                            text: "فایل CSV",
                            className: "btn-sm",
                        ...
                        { extend: "print", text: "چاپ", className: "btn-sm" },
                    ],
                    responsive: !0,
                });
        };
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        if ($("#mainb").length) {
            ...
            a.setOption({
                title: { text: "عنوان نمودار", subtext: "زیر عنوان نمودار" },
                tooltip: { trigger: "axis" },
                legend: { data: ["فروش‌ها", "خرید‌ها"] },
                toolbox: { show: !1 },
                calculable: !1,
                xAxis: [
                    {
        ...
        if ($("#echart_sonar").length) {
            ...
            t.setOption({
                title: { text: "بودجه در مقابل هزینه", subtext: "زیر عنوان" },
                ...
                toolbox: {
                    show: !0,
                    feature: {
                        restore: { show: !0, title: "بازگردانی" },
                        saveAsImage: { show: !0, title: "ذخیره تصویر" },
                    },
                },
                polar: [
                    {
                        indicator: [
                            { text: "فروش ها", max: 6e3 },
                            { text: "مدیریت", max: 16e3 },
                            { text: "فناوری اطلاعات", max: 3e4 },
                            { text: "پشتیبانی مشتری", max: 38e3 },
                            { text: "توسعه", max: 52e3 },
                            { text: "بازار یابی", max: 25e3 },
                        ],
                    },
                ],
                calculable: !0,
        ...
        if ($("#echart_pyramid").length) {
            ...
            n.setOption({
                title: { text: "نمودار اهراد هرم", subtext: "زیر عنوان" },
                ...
                series: [
                    {
                        ...
                        width: "40%",
                        data: [
                            { value: 60, name: "چیزی #1" },
                            { value: 40, name: "چیزی #2" },
                            { value: 20, name: "چیزی #3" },
                            { value: 80, name: "چیزی #4" },
                            { value: 100, name: "چیزی #5" },
                        ],
                    },
                ],
            });
        ...
        if ($("#echart_line").length) {
            ...
            i.setOption({
                title: { text: "نمودار خطی", subtext: "زیر عنوان" },
                tooltip: { trigger: "axis" },
                legend: {
                    x: 220,
                    y: 40,
        ...
        if ($("#echart_scatter").length) {
            ...
            r.setOption({
                title: { text: "نمودار پراکندگی", subtext: "هاینز 2003" },
                tooltip: {
                    trigger: "axis",
                    showDelay: 0,
                    axisPointer: {
        ...
        if ($("#echart_bar_horizontal").length) {
            ...
            a.setOption({
                title: { text: "نمودار میله‌ای", subtext: "زیر عنوان" },
                tooltip: { trigger: "axis" },
        ...
        if ($("#echart_pie").length) {
            var c = echarts.init(document.getElementById("echart_pie"), e);
            c.setOption({
                tooltip: {
                    trigger: "item",
                    formatter: "{a} <br/>{b} : {c} ({d}%)",
                ...
                series: [
                    {
                        ...
                        itemStyle: d,
                        data: [
                            { value: 68, name: "68%چیزی #1" },
                            { value: 32, name: "invisible", itemStyle: u },
                        ],
                    },
                    {
                        name: "2",
                        ...
                        itemStyle: d,
                        data: [
                            { value: 29, name: "29%چیزی #2" },
                            { value: 71, name: "invisible", itemStyle: u },
                        ],
                    },
                    {
                        name: "3",
                        ...
                        itemStyle: d,
                        data: [
                            { value: 3, name: "3%چیزی #3" },
                            { value: 97, name: "invisible", itemStyle: u },
                        ],
                    },
                ],
            });
